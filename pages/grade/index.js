...
<div class="p-4 flex space-x-4">
  <input class="w-full px-3 py-2 border rounded bg-white placeholder-gray-500 text-black" type="text" placeholder="Student Id" value={student_id_val == null || student_id_val == 'null' ? '' : student_id_val} onChange={(e) => setStudent_id(e.target.value)} />
  <input class="w-full px-3 py-2 border rounded bg-white placeholder-gray-500 text-black" type="text" placeholder="Balgurukul Id" value={bg_id_val == null || bg_id_val == 'null' ? '' : bg_id_val} onChange={(e) => setBg_id(e.target.value)} />
  <input class="w-full px-3 py-2 border rounded bg-white placeholder-gray-500 text-black" type="text" placeholder="Exam" value={exam_val == null || exam_val == 'null' ? '' : exam_val} onChange={(e) => setExam(e.target.value)} />
  <input class="w-full px-3 py-2 border rounded bg-white placeholder-gray-500 text-black" type="text" placeholder="Class" value={grade_val == null || grade_val == 'null' ? '' : grade_val} onChange={(e) => setGrade(e.target.value)} />
  <input class="w-full px-3 py-2 border rounded bg-white placeholder-gray-500 text-black" type="date" value={dateGreater_val == null || dateGreater_val == 'null' ? '' : dateGreater_val} onChange={(e) => setDateGreater(e.target.value)} />
  <input class="w-full px-3 py-2 border rounded bg-white placeholder-gray-500 text-black" type="date" value={dateLesser_val == null || dateLesser_val == 'null' ? '' : dateLesser_val} onChange={(e) => setDateLesser(e.target.value)} />
  <button class="bg-blue-400 hover:bg-blue-600 rounded-3xl p-1 px-1 font-bold w-full text-white" name="Reset" onClick={() => { setStudent_id(null); setBg_id(null); setExam(null); setGrade(null); setDateGreater(null); setDateLesser(null) }}>Reset Filters</button>
</div>
