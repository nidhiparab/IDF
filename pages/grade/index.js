...
<div className="p-4 flex space-x-4">
  ...
  <input className="w-full px-3 py-2 border rounded bg-white placeholder-gray-500 text-black" type="date" value={dateGreater_val == null || dateGreater_val == 'null' ? '' : dateGreater_val} onChange={(e) => setDateGreater(e.target.value)} style={{ backgroundImage: "url('data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 24 24%22%3E%3Cpath fill=%22black%22 d=%22M3 4v16h18V4H3zm16 14H5V8h14v10zM5 6h14v2H5V6z%22/%3E%3Cpath fill=%22none%22 d=%22M0 0h24v24H0z%22/%3E%3C/svg%3E')", backgroundRepeat: "no-repeat", backgroundPosition: "right 8px center", backgroundSize: "16px 16px" }} />

<input className="w-full px-3 py-2 border rounded bg-white placeholder-gray-500 text-black" type="date" value={dateLesser_val == null || dateLesser_val == 'null' ? '' : dateLesser_val} onChange={(e) => setDateLesser(e.target.value)} style={{ backgroundImage: "url('data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 24 24%22%3E%3Cpath fill=%22black%22 d=%22M3 4v16h18V4H3zm16 14H5V8h14v10zM5 6h14v2H5V6z%22/%3E%3Cpath fill=%22none%22 d=%22M0 0h24v24H0z%22/%3E%3C/svg%3E')", backgroundRepeat: "no-repeat", backgroundPosition: "right 8px center", backgroundSize: "16px 16px" }} />
